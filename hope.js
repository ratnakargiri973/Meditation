...
startAudio.src = "voiceAssist.mp3";
endAudio.src = "voiceAssist.mp3";
...
function showusermsg(usermsg) {
  let output = "";
  output += `<div class="chatarea-inner user"><img src="profile.jpeg">${usermsg}</div>`;
...
function showchatbotmsg(chatbotmsg) {
  let output = "";
  output += `<div class="chatarea-inner chatbot"><img src="hope-logo.png">${chatbotmsg}</div>`;
  chatareaouter.innerHTML += output;
  return chatareaouter;
}
